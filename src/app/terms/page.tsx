...
export const metadata: Metadata = {
  title: "Terms of Use | Soroswap",
  description: "Terms of Use for Soroswap decentralized exchange platform",
};
        ...
        <div className="prose prose-lg flex max-w-none flex-col gap-4 space-y-2">
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              Soroswap. Please read them carefully.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              Soroswap is a decentralized platform that enables Users to trade
              digital assets, such as cryptocurrencies and tokens, directly with
              one another, without the need for an intermediary. Our platform
              operates using smart contracts and blockchain technology to
              facilitate peer-to-peer transactions.
            </p>
            <p>The services provided by Soroswap include:</p>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              jurisdiction to use the services of the Exchange. By accessing and
              using the Exchange, you confirm that you meet the eligibility
              criteria.
            </p>
            <p>
              You also represent and warrant that you are not located in, or a
              resident of, any jurisdiction where the use of decentralized
              exchange services is prohibited or restricted.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              digital wallet or connecting via third-party services (such as
            ...
            <p>
              ...
              private keys, passwords, and any other credentials. The Exchange
              will not be liable for any loss of funds due to compromised keys
              or security breaches on your part.
            </p>
            <p>
              <strong>Transactions:</strong> You agree to conduct all
              transactions through your digital wallet, and you are responsible
              for confirming the details of each transaction before initiating
              it.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              Investments in blockchain assets may result in loss of part or all
              of your investment. Please do your own research and use caution.
              You are solely responsible for your actions on the Stellar
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              control the actions of others on the Stellar network. When using
              Soroswap, you are communicating with the Stellar network.
              Transactions on the Stellar network are irreversible. Soroswap is
              not a custodian of your assets. We do not store any tokens,
          ...
          <section className="flex flex-col gap-4">
            ...
            <ul className="ml-6 list-disc space-y-2">
              ...
              <li>
                Not use the Exchange for illegal activities, including the
                trading of illicit or prohibited assets.
              </li>
            </ul>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              are stored in your wallet, and you retain full control of your
              private keys.
            </p>
            <p>
              We do not provide any custodial services, and we do not have
              access to your funds. It is your responsibility to safeguard your
              assets.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <ul className="ml-6 list-disc space-y-2">
              <li>
                Soroswap is not liable for any loss or damage arising from the
                use of the Exchange or any transaction executed on the platform.
              </li>
              <li>
                Soroswap does not guarantee the security, stability, or
                availability of the platform at all times.
              </li>
              <li>
                The Exchange is not liable for any losses due to technical
                issues, such as network outages or smart contract failures.
              </li>
              <li>
                You, the user, are solely responsible for ensuring your own
                compliance with laws and taxes in your jurisdiction.
                Cryptocurrencies may be illegal in your area. You are solely
                responsible for your own security, including keeping your
                account secret keys safe and backed up.
              </li>
            </ul>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              provide certain information through your wallet or third-party
              services. Please review the privacy policy.
            </p>
          </section>
