...
export default function BridgePage() {
  return (
    <main className="mt-[100px] flex min-h-[calc(100vh-100px)] flex-col items-center justify-center px-4 py-10">
      <div className="mx-auto mb-4 flex w-fit max-w-xl items-center justify-center gap-2 rounded-lg border border-[var(--color-brand)] bg-[var(--color-blue-100)] p-3 text-[var(--color-blue-900)] dark:border-[var(--color-brand)] dark:bg-[var(--color-surface-subtle)] dark:text-[var(--color-primary)]">
        <div className="text-center text-sm sm:text-base">
          <p className="text-sm leading-relaxed text-[var(--color-blue-900)] dark:text-[var(--color-primary)]">
