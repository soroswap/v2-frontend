      ...
      <div className="rounded-2xl border border-[#8866DD] bg-[#181A25] shadow-xl p-4 sm:p-8 w-full max-w-[480px] relative">
        ...
        <div className="bg-[#10121A] rounded-2xl p-4 sm:p-5 mb-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button className="flex items-center gap-2 bg-[#23243a] rounded-full px-3 py-2 sm:px-4 sm:py-2 font-bold text-white text-base sm:text-lg">
              <img src="https://assets.coingecko.com/coins/images/100/standard/Stellar_symbol_black_RGB.png" alt="XLM logo" width={24} height={24} className="rounded-full sm:w-[28px] sm:h-[28px] w-[24px] h-[24px]" />
              <span>XLM</span>
            ...
            <input
              className="flex-1 bg-transparent text-right text-xl sm:text-2xl text-[#E0E0E0] placeholder:text-[#A0A3C4] outline-none opacity-40 py-2"
              type="text"
              placeholder="0"
              disabled
            />
        ...
        <div className="bg-[#10121A] rounded-2xl p-4 sm:p-5 mb-6 border border-[#23243a]">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button className="flex items-center gap-2 bg-[#8866DD] rounded-full px-3 py-2 sm:px-4 sm:py-2 font-bold text-white text-base sm:text-lg">
